...
<!-- 导航栏 -->		 
   <div id ="topnav">
			...
			<li><a href="../Main pagination bar/cryptography .php">漏洞挖掘</a></li>
          	<li><a href="../Main pagination bar/wireless security.php">移动安全</a></li>
          	<li><a href="../Main pagination bar/vulnerability.php">CTF竞赛</a></li>
            </ul>
 		 </div> 
...
<div class="center">
        ...
        <li><a href="https://www.cnblogs.com/zhaoyixiang/p/10970117.html">CTF—WEB—sql注入之宽字节注入</a></li> 
			...
			?>
				...
				<!-- 左子页 !-->
		<div id="Inf"><div class="InfTi">联系方式</div>
